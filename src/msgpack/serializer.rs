...
struct FragmentSerializer<'a, W> {
    writer: &'a mut W,
}

impl<'a, W> FragmentSerializer<'a, W>
where
    W: WriteSlices,
{
    #[inline]
...
impl<W> ser::Serializer for &mut FragmentSerializer<'_, W>
where
    W: WriteSlices,
{
    type Ok = ();
    ...
    W: WriteSlices,
{
    ...
    where
        T: ?Sized + ser::Serialize,
    {
        let mut fragment_se = FragmentSerializer::new(&mut self.writer);
        value.serialize(&mut fragment_se)
    }
